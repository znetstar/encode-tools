...
export type ImageFormat = Regular.ImageFormat;
export type IDFormat = Regular.IDFormat;
export type SerializationFormat = Regular.SerializationFormat;
export type CompressionFormat = Regular.CompressionFormat;
export type HashAlgorithm = Regular.HashAlgorithm;
export type EncodeToolsFormat = Regular.EncodeToolsFormat;
